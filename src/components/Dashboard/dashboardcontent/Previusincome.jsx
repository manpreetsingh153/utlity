...
const Previusincome = () => {
  return (
    <div>
      {" "}
      <Card className="border-0 spending px-2 shadow-lg rounded-4">
        <div className="card-title pt-3 px-4 fw-bold d-flex justify-content-between">
          ...
          <div className="option d-flex my-auto">
            <div className="btn btn-success">Monthly</div>
        ...
        <div className="card-body">
          <div className="row g-3">
            ...
            <div className="col-3">
              <div className="card-title fw-bold">XYZ </div>
              <div className="small">
                <small>Lorem </small>{" "}
              </div>
            </div>
            <div className="col-2">
              <div className="card-title fw-bold">date </div>
              <div className="small">
                <small>5.44.45PM </small>{" "}
              </div>
            </div>
            <div className="col-2">
            ...
            <div className="col-3">
              <div className="card-title text-success">complete </div>
            </div>
            <div className="col-2">
              <svg
                width={63}
