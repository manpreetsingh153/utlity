...
import Purchase from "@/components/Dashboard/purchaseorder/Purchase";
...
const Mainpurchase = () => {
  ...
  const addInput = () => {
    setInputs([
      ...inputs,
      { itemname: "", quantity: "", rate: "", timestamp: "" },
    ]);
  };
  ...
  const handlePrints = async () => {
    ...
    // console.log(text.po);
    text.id = date;
    text.email = session.data?.user.email;
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-6">
                      <div className="form-floating">
                        ...
                        />
                        <label htmlFor="floatingTextarea2">Vender Name</label>
                      </div>
                      <div className="form-floating">
                        <input
                          type="text"
                    ...
                    <div className="col-md-12">
                      <div className="form-floating">
                        <input
                          ...
                          value={text.ordedate}
                        />
                        <label htmlFor="floatingTextarea2">Order Date</label>
                      </div>
                    </div>
                    <div className="col-md-12">
                      <div className="form-floating">
                    ...
                    <div className="col-md-12">
                      <div className="form-floating">
                        <input
                          ...
                          value={text.duedate}
                        />
                        <label htmlFor="floatingTextarea2">Delivery Date</label>
                      </div>
                    </div>
                  </div>
                </div>
